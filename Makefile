...
cor-sdmmpredicthrt-pst:
	java -Xms30072m -cp target/svm-ise.jar edu.ise.svm.experiments.modelbased.SDMMPrediction data/model_partition/heart/  heart_positive_cr_isesvm_test_x_bin.2 heart_positive_cr_isesvm_test_y.2.bin model/heart/2/positive weighted_acc_heart_positive_cr_isesvm_test_x_bin.1 2
...
cor-sdmmpredicthrt-ngt:
	java -Xms30072m -cp target/svm-ise.jar edu.ise.svm.experiments.modelbased.SDMMPrediction data/model_partition/heart/  heart_negative_cr_isesvm_test_x_bin.2 heart_negative_cr_isesvm_test_y.2.bin model/heart/2/negative weighted_acc_heart_negative_cr_isesvm_test_x_bin.1 2
...
cor-sdmmtest-ijcnn-pst:
	java -Xms30072m -cp target/svm-ise.jar edu.ise.svm.experiments.modelbased.SDMMTesting data/model_partition/ijcnn1/ ijcnn_positive_cr_isesvm_test_x_bin.1 ijcnn_positive_cr_isesvm_test_y.1.bin model/ijcnn1/2/positive
...
cor-sdmmtest-ijcnn-ngt:
	java -Xms30072m -cp target/svm-ise.jar edu.ise.svm.experiments.modelbased.SDMMTesting data/model_partition/ijcnn1/ ijcnn_negative_cr_isesvm_test_x_bin.1 ijcnn_negative_cr_isesvm_test_y.1.bin model/ijcnn1/2/negative
