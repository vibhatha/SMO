package edu.ise.svm.experiments.dynamic.single;
...
public class SDMMPrediction {
    ...
    public static void main(String[] args) throws IOException{
        ...
        String expName =  UtilDynamicSingle.optArgs(args, Constant.DYNAMIC_PREDICTING)[1];
        MODEL_PATH = args[3];
...
* **/
    ...
    public static ArrayList<Model> loadModels() throws IOException {
        ...
        modelPaths = UtilDynamicSingle.loadPaths(MODEL_PATH);
