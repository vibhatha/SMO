...
java -Xmx2G -Xms2G -cp target/svm-ise.jar edu.ise.svm.smo.newton.sdsm.SVM ~/data/libsvm/${datasource}/ ${datasource}_isesvm_train_x_bin.1 ${datasource}_isesvm_train_y.1.bin ${datasource}_isesvm_test_x_bin.1 ${datasource}_isesvm_test_y.1.bin model/single/${datasource}/${expid} ${partitions} ${Cval} ${gamma} ${kernel} ${baseacc} ${datasource}
